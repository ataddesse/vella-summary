/* This BertProcessor is a copy of: 
https://github.com/cassiebreviu/bert-excel-addin-ort-web/blob/e470996f33f27edd07283326f934e96f25fab3b6/src/functions/bert/bertProcessing.ts
and it is slightly modified for use in react native. 
*/

/* eslint-disable no-undef */
import * as ort from 'onnxruntime-react-native';

export async function createModelInput(encoded: number[]) {
